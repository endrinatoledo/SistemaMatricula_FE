...
// const ruta = require('../../../impresiones/')
...
const GenerarComprobanteFicalFile = ({ numControl, numFact, datosCompletos, datosPago, tasaDelDia, datosCabecera, pagosRegistrados }) => {
  ...
  console.log('entrooooooooooooooooooooooooooooooooooooooooooooooooooooo')
...
export default GenerarComprobanteFicalFile